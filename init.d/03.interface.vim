...
set regexpengine=1                  " This selects the default regexp engine.
set linebreak                       " Vim to only wrap at a character in the breakat option
set linespace=0                     " don't insert any extra pixel lines between rows
set list                            " show traling listchars
set listchars=tab:»·,trail:·,nbsp:· " Strings to use in 'list' mode and for the :list command.
...
set wildoptions=pum                 " List of words that change how cmdline-completion is done.
set pumblend=10                     " Enables pseudo-transparency for the popup-menu
set winblend=10                     " Enables pseudo-transparency for a floating window.
